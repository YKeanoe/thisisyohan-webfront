...
const MailIcon = ({ style }: Props) => {
  return (
    <svg
      ...
      enableBackground={'new 0 0 109.294 109.294'}
      xmlSpace="preserve"
      style={style}
    >
      <g>
        <path
          d="M54.648,48.141L101.063,19.2c-0.505-0.08-1.017-0.132-1.542-0.132H9.775c-0.525,0-1.038,0.054-1.541,0.132L54.648,48.141z"
        />
        <path
          d="M57.569,59.331c-0.062,0.04-0.13,0.066-0.194,0.104c-0.067,0.037-0.139,0.073-0.206,0.107
